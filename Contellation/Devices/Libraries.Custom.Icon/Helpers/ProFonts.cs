using Libraries.Custom.Icon.Enums;
...
namespace Libraries.Custom.Icon.Helpers
{
    ...
    {
        { (int)IconFont.Regular,  "Font Awesome 6 Pro Regular"}, // fa-regular-400-pro.ttf
        { (int)IconFont.Solid, "Font Awesome 6 Pro Solid"}, // fa-solid-900-pro.ttf
        { (int)IconFont.Light, "Font Awesome 6 Pro Light"}, // fa-light-300-pro.ttf
        { (int)IconFont.Thin, "Font Awesome 6 Pro Thin"}, // fa-thin-100-pro.ttf
        ...
        public static WpfFont WpfFontFor(this IconType icon, IconFont iconFont = IconFont.Auto)
        {
        ...
        internal static WpfTypeface TypeFaceFor(this IconType icon, IconFont iconFont)
        {
            if (iconFont == IconFont.Auto) return WpfTypefaces.Find(icon, out _, out _);
        ...
        public static void InitializeWinForms(Assembly fontsAssembly = null, string path = "fonts")
        {
            ...
            {
                try { _winFormsFonts.AddFont(fontFile, assembly, path); }
                catch (Exception ex)
                {
        ...
        public static WinFormsFont WinFormsFontFor(this IconType icon)
        {
