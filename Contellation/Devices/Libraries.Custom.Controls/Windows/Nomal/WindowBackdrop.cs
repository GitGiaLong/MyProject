...
namespace Libraries.Custom.Controls.Windows.Nomal
{
    /// <summary>
    ...
    public static class WindowBackdrop
    {
        ...
        public static bool IsSupported(WindowBackdropType backdropType)
        {
            return backdropType switch
            {
                ...
                WindowBackdropType.None => true, _ => false
            };
        }
        ...
        public static bool RemoveBackdrop(IntPtr hWnd)
        {
            ...
            _ = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT,
                ref pvAttribute, Marshal.SizeOf(typeof(int)));

            _ = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE,
        ...
        private static bool ApplyDwmwWindowAttrubute(IntPtr hWnd, Dwmapi.DWMSBT dwmSbt)
        {
            ...
            var dwmApiResult = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE,
                ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        private static bool ApplyLegacyMicaBackdrop(IntPtr hWnd)
        {
            ...
            var dwmApiResult = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT,
                ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
