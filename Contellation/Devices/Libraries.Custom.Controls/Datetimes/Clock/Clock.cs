using Libraries.Custom.Controls.Datetimes.Clock;
...
namespace Libraries.Custom.Controls
{
    ...
    public class Clock : ClockBase
    {
        ...
        {
            get { return (Style)GetValue(ClockRadioButtonStyleProperty); }
            set { SetValue(ClockRadioButtonStyleProperty, value); }
        }
        public static readonly DependencyProperty ClockRadioButtonStyleProperty = DependencyProperty.Register(nameof(ClockRadioButtonStyle), typeof(Style),
            typeof(Clock), new PropertyMetadata(default(Style)));
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (_borderTitle != null) { _borderTitle.MouseWheel -= BorderTitle_OnMouseWheel; }
