...
namespace Libraries.Custom.Controls
{
    ...
    public class Arc : System.Windows.Shapes.Shape
    {
        ...
        public static readonly DependencyProperty StartAngleProperty = DependencyProperty.Register(nameof(StartAngle),
            typeof(double), typeof(Arc), new PropertyMetadata(0.0d, PropertyChangedCallback));
        ...
        protected Geometry GetDefiningGeometry()
        {
            ...
            using (StreamGeometryContext context = geometryStream.Open())
            {
                ...
                context.ArcTo(PointAtAngle(Math.Max(StartAngle, EndAngle)), arcSize, 0, IsLargeArc,
