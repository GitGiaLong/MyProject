using Libraries.Custom.Controls.Windows.Nomal;
using Libraries.Custom.Enums.Windows;
using Libraries.Custom.Extensions.Intputs;
using Libraries.Custom.Interops.Unsafes;
using Size = System.Windows.Size;
using MessageBoxButton = Libraries.Custom.Enums.Control.MessageBox.MessageBoxButton;
using MessageBoxResult = Libraries.Custom.Enums.Control.MessageBox.MessageBoxResult;
...
namespace Libraries.Custom.Controls
{
    ...
    public class MessageBox : System.Windows.Window
    {
        ...
        protected TaskCompletionSource<Enums.Control.MessageBox.MessageBoxResult>? Tcs { get; set; }
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            CancellationTokenRegistration tokenRegistration = cancellationToken.Register(o => Tcs.TrySetCanceled((CancellationToken)o!),
                cancellationToken);
            ...
            try
            {
                ...
                if (showAsDialog) { base.ShowDialog(); }
                else { base.Show(); }
        ...
        private void ResizeWidth(UIElement element)
        {
            ...
            if (Height > MaxHeight) { SetCurrentValue(MaxHeightProperty, Height); }
        }
        ...
        private void ResizeHeight(UIElement element)
        {
            ...
            if (Width > MaxWidth) { SetCurrentValue(MaxWidthProperty, Width); }
        }
    }
}
