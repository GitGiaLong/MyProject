...
namespace Libraries.Custom.Extensions.Interactivity
{
    ...
    [DefaultTrigger(typeof(ButtonBase), typeof(Events.EventTrigger), "Click")]
    [DefaultTrigger(typeof(TextBox), typeof(Events.EventTrigger), "TextChanged")]
    [DefaultTrigger(typeof(RichTextBox), typeof(Events.EventTrigger), "TextChanged")]
    [DefaultTrigger(typeof(ListBoxItem), typeof(Events.EventTrigger), "Selected")]
    [DefaultTrigger(typeof(TreeViewItem), typeof(Events.EventTrigger), "Selected")]
    [DefaultTrigger(typeof(Selector), typeof(Events.EventTrigger), "SelectionChanged")]
    [DefaultTrigger(typeof(TreeView), typeof(Events.EventTrigger), "SelectedItemChanged")]
    [DefaultTrigger(typeof(RangeBase), typeof(Events.EventTrigger), "ValueChanged")]
    ...
    [DefaultTrigger(typeof(FrameworkElement), typeof(Events.EventTrigger), "Loaded")]
    [DefaultTrigger(typeof(ButtonBase), typeof(Events.EventTrigger), "Loaded")]
