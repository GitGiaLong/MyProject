...
namespace Core.Libraries.WPF.Controls.Texts.TextBoxMasked.Filter
{
    ...
    public class RegExFilter : BaseFilter
    {
        ...
        public RegExFilter(String regExp) : this(regExp, (int?)null) { }
        ...
        {
            return (_regEx == null) || _regEx.Match(newText).Success;
        }
