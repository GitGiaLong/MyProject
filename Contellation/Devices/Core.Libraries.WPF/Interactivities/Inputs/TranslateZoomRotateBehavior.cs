...
namespace Core.Libraries.WPF.Interactivities.Inputs
{
    public class TranslateZoomRotateBehavior : Behavior<FrameworkElement>
    {
        ...
        public static readonly DependencyProperty SupportedGesturesProperty = DependencyProperty.Register(nameof(SupportedGestures), typeof(ManipulationModes),
        ...
        public static readonly DependencyProperty TranslateFrictionProperty = DependencyProperty.Register(nameof(TranslateFriction), typeof(double),
                typeof(TranslateZoomRotateBehavior), new PropertyMetadata(0.0, frictionChanged, coerceFriction));
        ...
        public static readonly DependencyProperty RotationalFrictionProperty = DependencyProperty.Register(nameof(RotationalFriction), typeof(double),
                typeof(TranslateZoomRotateBehavior), new PropertyMetadata(0.0, frictionChanged, coerceFriction));
        ...
        public static readonly DependencyProperty MinimumScaleProperty = DependencyProperty.Register(nameof(MinimumScale), typeof(double),
                typeof(TranslateZoomRotateBehavior), new PropertyMetadata(0.1));
        ...
        public static readonly DependencyProperty MaximumScaleProperty = DependencyProperty.Register(nameof(MaximumScale), typeof(double),
                typeof(TranslateZoomRotateBehavior), new PropertyMetadata(10.0));
