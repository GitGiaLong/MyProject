...
namespace Core.Libraries.WPF.Interactivities.Extensions
{
    public class ExtendedVisualStateManager : VisualStateManager
    {
        internal class WrapperCanvas : Canvas
        {
            ...
            internal static readonly DependencyProperty SimulationProgressProperty = DependencyProperty.Register(nameof(SimulationProgress), typeof(double), typeof(WrapperCanvas), new PropertyMetadata(0d, SimulationProgressChanged));
