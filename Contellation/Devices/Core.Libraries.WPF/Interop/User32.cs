...
#pragma warning disable SA1401 // Fields should be private
    ...
    internal static class User32
    {
        ...
        [DllImport(WindowKernel.User32, CharSet = CharSet.Auto, SetLastError = true)]
        ...
        [DllImport(WindowKernel.User32, SetLastError = true, CharSet = CharSet.Unicode)]
        ...
        [DllImport(WindowKernel.User32, CharSet = CharSet.Unicode)]
        ...
        [DllImport(WindowKernel.User32, ExactSpelling = true)]
        ...
        /// <param name="lpString">The message to be registered.</param>
        /// <returns>If the message is successfully registered, the return value is a message identifier in the range 0xC000 through 0xFFFF.</returns>
        [DllImport(WindowKernel.User32, SetLastError = true, CharSet = CharSet.Auto)]
        ...
        [DllImport(WindowKernel.User32, EntryPoint = "EnableMenuItem")]
        ...
        [DllImport(WindowKernel.User32, EntryPoint = "SetWindowRgn", SetLastError = true)]
        ...
        [DllImport(WindowKernel.User32, EntryPoint = "SetWindowPos", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport(WindowKernel.User32, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi)]
