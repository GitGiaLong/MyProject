...
namespace Core.Libraries.WPF.Icons.Font.ToGeometries
{
    ...
    public abstract class ToGeometryBase<TEnum> : MarkupExtension where TEnum : struct, IConvertible, IComparable, IFormattable
    {
        ...
        protected void UpdateGeometry()
        {
            ...
            var ft = new FormattedText(_icon.ToChar(), CultureInfo.InvariantCulture, FlowDirection.LeftToRight, typeface, 1, IconHelper.DefaultBrush,
    ...
    var ft = new FormattedText(_icon.ToChar(), CultureInfo.InvariantCulture, FlowDirection.LeftToRight, typeface, 1, IconHelper.DefaultBrush);
        ...
        public override object ProvideValue(IServiceProvider serviceProvider) { return _geometry; }
    }
}
