...
namespace Libraries.Custom.Interactivities.Layouts
{
    ...
    public sealed class FluidMoveBehavior : FluidMoveBehaviorBase
    {
        ...
        public static readonly DependencyProperty DurationProperty = DependencyProperty.Register(nameof(Duration), typeof(Duration),
            typeof(FluidMoveBehavior), new PropertyMetadata(new Duration(TimeSpan.FromSeconds(1.0))));
        ...
        public static readonly DependencyProperty InitialTagProperty = DependencyProperty.Register(nameof(InitialTag), typeof(TagType),
            typeof(FluidMoveBehavior), new PropertyMetadata(TagType.Element));
        ...
        public static readonly DependencyProperty InitialTagPathProperty = DependencyProperty.Register(nameof(InitialTagPath), typeof(string),
            typeof(FluidMoveBehavior), new PropertyMetadata(String.Empty));

        private static readonly DependencyProperty initialIdentityTagProperty = DependencyProperty.RegisterAttached("InitialIdentityTag", typeof(object),
        ...
        public static readonly DependencyProperty FloatAboveProperty = DependencyProperty.Register(nameof(FloatAbove), typeof(bool),
            typeof(FluidMoveBehavior), new PropertyMetadata(true));
        ...
        public static readonly DependencyProperty EaseXProperty = DependencyProperty.Register(nameof(EaseX), typeof(IEasingFunction),
            typeof(FluidMoveBehavior), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EaseYProperty = DependencyProperty.Register(nameof(EaseY), typeof(IEasingFunction),
            typeof(FluidMoveBehavior), new PropertyMetadata(null));

        private static readonly DependencyProperty overlayProperty = DependencyProperty.RegisterAttached("Overlay", typeof(object),
            typeof(FluidMoveBehavior), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty cacheDuringOverlayProperty = DependencyProperty.RegisterAttached("CacheDuringOverlay", typeof(object),
            typeof(FluidMoveBehavior), new PropertyMetadata(null));
        ...
        private static readonly DependencyProperty hasTransformWrapperProperty = DependencyProperty.RegisterAttached("HasTransformWrapper", typeof(bool),
