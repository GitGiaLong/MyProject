...
using Libraries.Custom.Enums.Placements;
using Libraries.Custom.Extensions.Icon;
using Libraries.Custom.Icons.Methods;
...
namespace Libraries.Custom.Helpers.Icon
{
    ...
    public static class FormsIconHelper
    {
        ...
        public static Bitmap ToBitmap<TEnum>(this System.Drawing.FontFamily fontFamily, TEnum icon,
            ...
            double rotation = 0.0, OrientationPlacement flip = OrientationPlacement.Normal)
        ...
        /// <param Name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IconType icon, IconFont iconFont = IconFont.Auto,
            int size = DefaultSize, System.Drawing.Color? color = null,
            double rotation = 0.0, OrientationPlacement flip = OrientationPlacement.Normal)
        {
        ...
        /// <param Name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IconType icon, System.Drawing.Color? color = null,
            int size = DefaultSize, double rotation = 0.0, OrientationPlacement flip = OrientationPlacement.Normal)
        {
        ...
        /// <param Name="flip">Icon flip</param>
        /// <returns>The rendered bitmap</returns>
        public static Bitmap ToBitmap(this IconType icon, int width = DefaultSize, int height = DefaultSize, System.Drawing.Color? color = null,
            double rotation = 0.0, OrientationPlacement flip = OrientationPlacement.Normal)
        {
            var fontFamily = FontFamilyFor(icon);
        ...
        internal static System.Drawing.FontFamily FontFamilyFor(this IconType iconChar)
        {
        ...
        internal static System.Drawing.FontFamily FontFamilyFor(this IconType iconChar, IconFont iconFont)
        {
            ...
            Assembly assembly = null, string path = "Fonts")
        {
            ...
            fixed (byte* pFontData = fontBytes)
            {
                ...
                uint dummy = 0;
                NativeMethod.AddFontMemResourceEx((IntPtr)pFontData, (uint)fontBytes.Length, IntPtr.Zero, ref dummy);
            }
        }
        ...
        private static IntPtr CreateMemoryHdc(IntPtr hdc, int width, int height, out IntPtr dib)
        {
            ...
            var memoryHdc = NativeMethod.CreateCompatibleDC(hdc);
            NativeMethod.SetBkMode(memoryHdc, 1);
            ...
            dib = NativeMethod.CreateDIBSection(hdc, ref info, 0, out _, IntPtr.Zero, 0);
            NativeMethod.SelectObject(memoryHdc, dib);
