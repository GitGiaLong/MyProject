...
#pragma warning disable SA1401 // Fields should be private
    ...
    internal static class User32
    {
        ...
        [DllImport(LibrariesDLL.User32, CharSet = CharSet.Auto, SetLastError = true)]
        ...
        [DllImport(LibrariesDLL.User32, SetLastError = true, CharSet = CharSet.Unicode)]
        ...
        [DllImport(LibrariesDLL.User32, ExactSpelling = true)]
        ...
        /// <param name="lpString">The message to be registered.</param>
        /// <returns>If the message is successfully registered, the return value is a message identifier in the range 0xC000 through 0xFFFF.</returns>
        [DllImport(LibrariesDLL.User32, SetLastError = true, CharSet = CharSet.Auto)]
        ...
        [DllImport(LibrariesDLL.User32, EntryPoint = "EnableMenuItem")]
        ...
        [DllImport(LibrariesDLL.User32, EntryPoint = "SetWindowRgn", SetLastError = true)]
        ...
        [DllImport(LibrariesDLL.User32, EntryPoint = "SetWindowPos", SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [DllImport(LibrariesDLL.User32, CharSet = CharSet.Unicode, CallingConvention = CallingConvention.Winapi)]
