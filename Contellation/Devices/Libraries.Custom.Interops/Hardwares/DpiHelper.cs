...
using Libraries.Custom.Structs.Hardwares;
using System.Windows.Interop;

namespace Libraries.Custom.Interops.Hardwares
{
    ...
    internal static class DpiHelper
    {
        ...
        */
        ...
        {
            if (window is null) { return new DisplayDpi(DefaultDpi, DefaultDpi); }
        ...
        {
            if (windowHandle == IntPtr.Zero || !UnsafeNativeMethods.IsValidWindow(windowHandle)) { return new DisplayDpi(DefaultDpi, DefaultDpi); }
        ...
        {
            System.Reflection.PropertyInfo? dpiXProperty = typeof(SystemParameters).GetProperty("DpiX",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

            if (dpiXProperty == null) { return new DisplayDpi(DefaultDpi, DefaultDpi); }

            System.Reflection.PropertyInfo? dpiYProperty = typeof(SystemParameters).GetProperty("Dpi",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

            if (dpiYProperty == null) { return new DisplayDpi(DefaultDpi, DefaultDpi); }
