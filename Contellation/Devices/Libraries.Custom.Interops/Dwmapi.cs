...
namespace Libraries.Custom.Interops
{
    ...
    public static class Dwmapi
    {
        ...
        [DllImport(LibrariesDLL.Dwmapi, BestFitMapping = false)]
        ...
        [DllImport(LibrariesDLL.Dwmapi, PreserveSig = false)]
        ...
        [DllImport(LibrariesDLL.Dwmapi, EntryPoint = "#127", PreserveSig = false, CharSet = CharSet.Unicode)]
