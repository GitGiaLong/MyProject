namespace Libraries.Custom.Extensions
{
    ...
    internal class MultiStyle : MarkupExtension
    {
        ...
        public MultiStyle(string inputResourceKeys)
        {
            ...
            if (_resourceKeys.Length == 0) { throw new ArgumentException(); }
        }
        ...
        public override object ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            foreach (var resourceKey in _resourceKeys)
            {
                ...
                if (currentStyle == null) { throw new ArgumentException(); }
    ...
    internal static class StyleExtensions
    {
        public static void Merge(this Style style1, Style style2)
        {
            ...
            foreach (var currentSetter in style2.Setters) { style1.Setters.Add(currentSetter); }
            foreach (var currentTrigger in style2.Triggers) { style1.Triggers.Add(currentTrigger); }

            /// This code is only needed when using DynamicResources.
            foreach (var key in style2.Resources.Keys) { style1.Resources[key] = style2.Resources[key]; }
        }
    }
}
