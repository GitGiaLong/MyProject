...
namespace Core.Libraries.Systems.Extensions
{
    ...
    GetOSVersionFromRegistry();
        ...
        /// <summary> Gets a value indicating whether the operating system version is greater than or equal to 10.0* (build 10240). </summary>
        public static bool IsOSWindows10OrNewer => _osVersion.Build >= 10240;

        /// <summary> Gets a value indicating whether the operating system version is greater than or equal to 10.0* (build 22000). </summary>
        public static bool IsOSWindows11OrNewer => _osVersion.Build >= 22000;

        /// <summary> Gets a value indicating whether the operating system version is greater than or equal to 10.0* (build 22523). </summary>
        public static bool IsOSWindows11Insider1OrNewer => _osVersion.Build >= 22523;

        /// <summary> Gets a value indicating whether the operating system version is greater than or equal to 10.0* (build 22557). </summary>
        public static bool IsOSWindows11Insider2OrNewer => _osVersion.Build >= 22557;

        /// <summary> Gets a value indicating whether Desktop Window Manager (DWM) composition is enabled. </summary>
        public static bool IsCompositionEnabled
        {
            get
            {
                if (!IsOSVistaOrNewer) { return false; }

                _ = Interops.Dwmapi.DwmIsCompositionEnabled(out var pfEnabled);
    ...
    private static Version GetOSVersionFromRegistry()
    {
        int major = 0;
        {
            ...
            else if (TryGetRegistryKey(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion", "CurrentVersion", out var version))
            {
                ...
                if (versionParts.Length >= 2) { major = int.TryParse(versionParts[0], out int majorAsInt) ? majorAsInt : 0; }
            }
        }
        ...
        int minor = 0;
        {
            ...
            else if (TryGetRegistryKey(@"SOFTWARE\Microsoft\Windows NT\CurrentVersion", "CurrentVersion", out var version))
            {
                ...
                if (versionParts.Length >= 2) { minor = int.TryParse(versionParts[1], out int minorAsInt) ? minorAsInt : 0; }
            }
        }
