...
namespace Core.Libraries.Systems.Interops
{
    ...
    public static class Dwmapi
    {
        ...
        [DllImport(WindowKernel.Dwmapi, BestFitMapping = false)]
        ...
        [DllImport(WindowKernel.Dwmapi, PreserveSig = false)]
        ...
        [DllImport(WindowKernel.Dwmapi, PreserveSig = false)]
        public static extern int DwmSetIconicLivePreviewBitmap([In] IntPtr hWnd, [In] IntPtr hbmp, [In, Optional] POINT pptClient, [In] DWM_SIT dwSITFlags);
        ...
        /// <returns>If the function succeeds, it returns <c>S_OK</c>. Otherwise, it returns an <c>HRESULT</c> error code.</returns>
        [DllImport(WindowKernel.Dwmapi)]
        public static extern int DwmSetWindowAttribute([In] IntPtr hWnd, [In] DWMWINDOWATTRIBUTE dwAttribute, [In] ref int pvAttribute, [In] int cbAttribute);
        ...
        [DllImport(WindowKernel.Dwmapi)]
        public static extern int DwmGetWindowAttribute([In] IntPtr hWnd, [In] DWMWINDOWATTRIBUTE dwAttributeToGet, [In] ref int pvAttributeValue, [In] int cbAttribute);
        ...
        /// <returns>If the function succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
        [DllImport(WindowKernel.Dwmapi)]
        public static extern int DwmGetWindowAttribute([In] IntPtr hWnd, [In] int dwAttributeToGet, [In] ref int pvAttributeValue, [In] int cbAttribute);
        ...
        [DllImport(WindowKernel.Dwmapi, EntryPoint = "#127", PreserveSig = false, CharSet = CharSet.Unicode)]
