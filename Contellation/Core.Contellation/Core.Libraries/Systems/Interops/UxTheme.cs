...
#pragma warning disable SA1307 // Accessible fields should begin with upper-case letter
    ...
    public static class UxTheme
    {
        ...
        [DllImport(WindowKernel.UxTheme, PreserveSig = false)]
        ...
        [DllImport(WindowKernel.UxTheme)]
        ...
        [DllImport(WindowKernel.UxTheme, CharSet = CharSet.Unicode)]
        public static extern int GetCurrentThemeName([Out] StringBuilder pszThemeFileName, [In] int dwMaxNameChars, [Out] StringBuilder pszColorBuff,
            [In] int cchMaxColorChars, [Out] StringBuilder pszSizeBuff, [In] int cchMaxSizeChars);
    }
