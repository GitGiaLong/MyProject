...
namespace Core.Libraries.WPF.Interactivities
{
    public sealed class InvokeCommandAction : TriggerAction<DependencyObject>
    {
        ...
        public static readonly DependencyProperty CommandProperty = DependencyProperty.Register(nameof(Command), typeof(ICommand), typeof(InvokeCommandAction), null);
        ...
        public static readonly DependencyProperty CommandParameterProperty = DependencyProperty.Register(nameof(CommandParameter), typeof(object), typeof(InvokeCommandAction), null);
        ...
        public static readonly DependencyProperty EventArgsConverterProperty = DependencyProperty.Register(nameof(EventArgsConverter), typeof(IValueConverter), typeof(InvokeCommandAction), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EventArgsConverterParameterProperty = DependencyProperty.Register(nameof(EventArgsConverterParameter), typeof(object), typeof(InvokeCommandAction), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty EventArgsParameterPathProperty = DependencyProperty.Register(nameof(EventArgsParameterPath), typeof(string), typeof(InvokeCommandAction), new PropertyMetadata(null));
