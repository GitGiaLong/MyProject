...
namespace Core.Libraries.WPF.Interactivities
{
    internal sealed class Serializer
    {
        ...
        public class Data
        {
            ...
            [SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible", Justification = "The use of visible nested classes for serialization seems reasonable.")]
            ...
            [SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly", Justification = "These collections are not part of a 'public' API, and it's just too handy to be able to replace the whole list.")]
            [SuppressMessage("Microsoft.Design", "CA1002:DoNotExposeGenericLists", Justification = "These generic lists are fine in their context. There is no need to listen to individual changes and they are more performant.")]
