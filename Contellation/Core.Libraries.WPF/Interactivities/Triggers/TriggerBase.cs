...
namespace Core.Libraries.WPF.Interactivities
{
    ...
    public abstract class TriggerBase : Animatable, IBehavior
    {
        ...
        private static readonly DependencyPropertyKey ActionsPropertyKey = DependencyProperty.RegisterReadOnly(nameof(Actions), typeof(TriggerActionCollection), 
            typeof(TriggerBase), new FrameworkPropertyMetadata());
