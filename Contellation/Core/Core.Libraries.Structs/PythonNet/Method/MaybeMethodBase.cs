...
using Core.Libraries.PythonNet;
using System.Diagnostics;
using System.Reflection;
using System.Runtime.Serialization;

namespace Core.Libraries.Structs.PythonNet.Method
{
    [Serializable]
    internal struct MaybeMethodBase<T> : ISerializable where T : MethodBase
    {
        ...
        static MaybeMethodFlags Visibility(MethodBase method) => Flags(method) & MaybeMethodFlags.Visibility;
    }
}
