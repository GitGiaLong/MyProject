...
namespace Core.Libraries.PythonNet.PY
{
    public static class Py
    {
        ...
        public static PyModule CreateScope(string name) => new(name ?? throw new ArgumentNullException(nameof(name)));
        ...
        public class DebugGILState : GILState
        {
            ...
            internal DebugGILState() : base() { this.owner = Thread.CurrentThread; }
        ...
        public class KeywordArguments : PyDict
        {
            ...
            protected KeywordArguments(SerializationInfo info, StreamingContext context) : base(info, context) { }
        }
        ...
        public static KeywordArguments kw(params object?[] kv)
        {
            ...
            {
                if (kv[i] is not string key) { throw new ArgumentException("Keys must be non-null strings"); }

                BorrowedReference value;
                NewReference temp = default;
                if (kv[i + 1] is PyObject pyObj) { value = pyObj; }
                else
                {
                ...
                using (temp)
                {
                    ...
                    {
                        throw new ArgumentException(string.Format("Cannot add key '{0}' to dictionary.", key),
        ...
        public static void SetArgv()
        {
            ...
            catch (NotSupportedException) { args = Enumerable.Empty<string>(); }
        ...
        public static void With(PyObject obj, Action<dynamic> Body) => With(obj, (PyObject context) => Body(context));
    }
}
