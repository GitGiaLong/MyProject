...
namespace Core.Libraries.PythonNet.References
{
    ...
    ref struct NewReference
    {
        ...
        /// <summary>
        /// Creates a <see cref="NewReference"/> pointing to the same object
        /// </summary>
        [DebuggerHidden]
        public NewReference(BorrowedReference reference, bool canBeNull = false)
        {
            var address = canBeNull ? reference.DangerousGetAddressOrNull()
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        /// Creates a <see cref="NewReference"/> pointing to the same object
        /// </summary>
        public NewReference(in NewReference reference, bool canBeNull = false) : this(reference.BorrowNullable(), canBeNull) { }
        ...
        /// </summary>
        [Pure]
        public static NewReference DangerousFromPointer(IntPtr pointer) => new() { pointer = pointer };
        ...
        [Pure]
        [DebuggerHidden]
        internal static bool IsNull(in NewReference reference) => reference.pointer == IntPtr.Zero;
    }
}
