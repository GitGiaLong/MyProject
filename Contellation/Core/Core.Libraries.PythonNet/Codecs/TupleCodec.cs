...
namespace Core.Libraries.PythonNet.Codecs
{
    public sealed class TupleCodec<TTuple> : IPyObjectEncoder, IPyObjectDecoder
    {
        ...
        public PyObject? TryEncode(object value)
        {
            ...
            using var tuple = PyTuple_New(fieldCount);
            ...
            foreach (FieldInfo field in tupleType.GetFields())
            {
                ...
                PyTuple_SetItem(tuple.Borrow(), fieldIndex, pyItem.Steal());
                fieldIndex++;
            }
        ...
        public bool CanDecode(PyType objectType, Type targetType)
            => PythonReferenceComparer.Instance.Equals(objectType, PyTupleType)
        ...
        public bool TryDecode<T>(PyObject pyObj, out T? value)
        {
            ...
            if (!PyTuple_Check(pyObj)) { return false; }
            ...
            nint itemCount = PyTuple_Size(pyObj);
            ...
            {
                BorrowedReference pyItem = PyTuple_GetItem(pyObj, itemIndex);
        ...
        {
            long itemCount = PyTuple_Size(tuple);
            ...
            {
                var pyItem = PyTuple_GetItem(tuple, itemIndex);
        ...
        static readonly MethodInfo[] tupleCreate = typeof(TTuple).GetMethods(BindingFlags.Public | BindingFlags.Static)
            .Where(m => m.Name == nameof(Tuple.Create)).OrderBy(m => m.GetParameters().Length).ToArray();
