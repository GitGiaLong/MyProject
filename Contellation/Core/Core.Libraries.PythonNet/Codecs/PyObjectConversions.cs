...
namespace Core.Libraries.PythonNet.Codecs
{
    ...
    public static class PyObjectConversions
    {
        ...
        public static void RegisterDecoder(IPyObjectDecoder decoder)
        {
            ...
            lock (decoders) { decoders.Add(decoder); }
        }
        ...
        static readonly ConcurrentDictionary<Type, IPyObjectEncoder[]> clrToPython = new();
        ...
        struct TypePair : IEquatable<TypePair>
        {
            ...
            public override int GetHashCode() => this.ClrType.GetHashCode() ^ this.PyType.GetHashCode();

            public bool Equals(TypePair other) => this.PyType == other.PyType && this.ClrType == other.ClrType;
