...
using Core.Libraries.Structs.PythonNet.Native;
...
namespace Core.Libraries.PythonNet.Runtimes
{
    ...
    public unsafe partial class Runtime
    {
        ...
        internal static void Initialize(bool initSigs = false)
        {
            ...
            bool interpreterAlreadyInitialized = TryUsingDll(() => Py_IsInitialized() != 0);
        ...
        [ForbidPythonThreads]
        public static bool TryCollectingGarbage(int runs) => TryCollectingGarbage(runs, forceBreakLoops: false);
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        internal static NewReference PyObject_Type(BorrowedReference o) => Delegates.PyObject_Type(o);
        ...
        internal static void AssertNoErorSet()
        {
            ...
            {
                throw new InvalidOperationException("Can't call with exception set", PythonException.FetchCurrent());
            }
        }
        ...
        {
            if (Delegates._Py_NewReference != null) { Delegates._Py_NewReference(ob); }
        }
        ...
        internal static bool PyInt_Check(BorrowedReference ob) => PyObject_TypeCheck(ob, PyLongType);
        ...
        internal static NewReference PyString_FromString(string value)
        {
            ...
            fixed (char* ptr = value)
                return Delegates.PyUnicode_DecodeUTF16(
                    (IntPtr)ptr, value.Length * sizeof(Char),
                    IntPtr.Zero, (IntPtr)byteorderPtr);
        }
