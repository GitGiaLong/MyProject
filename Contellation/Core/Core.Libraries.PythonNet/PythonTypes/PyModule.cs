...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public class PyModule : PyObject
    {
        ...
        internal BorrowedReference VarsRef
        {
            get
            {
                var vars = PyModule_GetDict(Reference);
        ...
        static StolenReference Create(string name)
        {
            ...
            return PyModule_New(name).StealOrThrow();
        }
        ...
        protected PyModule(SerializationInfo info, StreamingContext context) : base(info, context) { }

        private void InitializeBuiltins()
        {
            int res = PyDict_SetItem(VarsRef, PyIdentifier.__builtins__, PyEval_GetBuiltins());
        ...
        public static PyObject Import(string name)
        {
            ...
            NewReference op = PyImport_ImportModule(name);
        ...
        {
            NewReference op = PyImport_ReloadModule(this.Reference);
        ...
        {
            // Force valid value
            if (string.IsNullOrWhiteSpace(file)) { file = "none"; }

            using NewReference c = Py_CompileString(code, file, (int)RunFlagType.File);
            NewReference m = PyImport_ExecCodeModule(name, c.BorrowOrThrow());
            return new PyModule(m.StealOrThrow());
        }

        public PyModule SetBuiltins(PyDict builtins)
        {
            if (builtins == null || builtins.IsNone()) { throw new ArgumentNullException(nameof(builtins)); }

            BorrowedReference globals = PyModule_GetDict(this.Reference);
            PythonException.ThrowIfIsNull(globals);
            int rc = PyDict_SetItemString(globals, "__builtins__", builtins.Reference);
        ...
        public static PyDict SysModules
        {
            get
            {
                BorrowedReference sysModulesRef = PyImport_GetModuleDict();
        ...
        internal static bool IsModule(BorrowedReference reference)
        {
            ...
            BorrowedReference type = PyObject_TYPE(reference);
            return PyType_IsSubtype(type, PyModuleType);
        }
        ...
        public void ImportAll(PyModule module)
        {
            ...
            int result = PyDict_Update(VarsRef, module.VarsRef);
        ...
        public void ImportAll(PyObject module)
        {
            ...
            var module_dict = PyModule_GetDict(module.Reference);
            int result = PyDict_Update(VarsRef, module_dict);
            if (result < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public void ImportAll(PyDict dict)
        {
            ...
            int result = PyDict_Update(VarsRef, dict.Reference);
            if (result < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public PyObject Execute(PyObject script, PyDict? locals = null)
        {
            ...
            using var ptr = PyEval_EvalCode(script, variables, _locals);
        ...
        public PyObject Eval(string code, PyDict? locals = null)
        {
            ...
            NewReference reference = PyRun_String(code, RunFlagType.Eval, VarsRef, _locals);
        ...
        {
            using NewReference reference = PyRun_String(code, RunFlagType.File, _globals, _locals);
            PythonException.ThrowIfIsNull(reference);
        }
        ...
        private void SetPyValue(string name, BorrowedReference value)
        {
            ...
            int r = PyObject_SetItem(variables, pyKey.obj, value);
        ...
        public PyModule Remove(string name)
        {
            ...
            using (var pyKey = new PyString(name))
            {
                int r = PyObject_DelItem(variables, pyKey.obj);
                if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
            }
            return this;
        }
        ...
        public bool Contains(string name)
        {
            ...
            Check();
            using var pyKey = new PyString(name);
            return PyMapping_HasKey(variables, pyKey.obj) != 0;
        }
        ...
        public bool TryGet(string name, out PyObject? value)
        {
            ...
            Check();
            using var pyKey = new PyString(name);
            if (PyMapping_HasKey(variables, pyKey.obj) != 0)
            {
                using var op = PyObject_GetItem(variables, pyKey.obj);
