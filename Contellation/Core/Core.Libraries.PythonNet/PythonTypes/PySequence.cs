...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public class PySequence : PyIterable
    {
        ...
        public static bool IsSequenceType(PyObject value)
        {
            ...
            return PySequence_Check(value.obj);
        }
        ...
        {
            using var op = PySequence_GetSlice(obj, i1, i2);
        ...
        public void SetSlice(int i1, int i2, PyObject v)
        {
            ...
            int r = PySequence_SetSlice(obj, i1, i2, v.obj);
        ...
        {
            int r = PySequence_DelSlice(obj, i1, i2);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public nint Index(PyObject item)
        {
            ...
            nint r = PySequence_Index(obj, item.obj);
            if (r < 0)
            {
                PyErr_Clear();
                return -1;
        ...
        public bool Contains(PyObject item)
        {
            ...
            int r = PySequence_Contains(obj, item.obj);
        ...
        public PyObject Concat(PyObject other)
        {
            ...
            using var op = PySequence_Concat(obj, other.obj);
            PythonException.ThrowIfIsNull(op);
            return op.MoveToPyObject();
        }
        ...
        {
            using var op = PySequence_Repeat(obj, count);
            PythonException.ThrowIfIsNull(op);
            return op.MoveToPyObject();
        }
    }
