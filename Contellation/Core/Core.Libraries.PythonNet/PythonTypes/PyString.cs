...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public class PyString : PySequence, IComparable<string>, IEquatable<string>
    {
        ...
        private static BorrowedReference FromObject(PyObject o)
        {
            ...
            if (!IsStringType(o)) { throw new ArgumentException("object is not a string"); }
            return o.Reference;
        }
        ...
        /// </remarks>
        public PyString(string s) : base(PyString_FromString(s).StealOrThrow()) { }
        ...
        {
            return PyString_Check(value.obj);
        }
        ...
        {
            string? result = GetManagedString(this.Reference);
            Debug.Assert(result is not null);
            return result!;
        }

        public bool Equals(string? other) => this.ToStringUnderGIL().Equals(other, StringComparison.CurrentCulture);
        public int CompareTo(string? other) => string.Compare(this.ToStringUnderGIL(), other, StringComparison.CurrentCulture);
