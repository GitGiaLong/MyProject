...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public partial class PyInt : PyNumber, IFormattable
    {
        ...
        /// </remarks>
        public PyInt(int value) : base(PyInt_FromInt32(value).StealOrThrow()) { }
        ...
        /// </remarks>
        public PyInt(long value) : base(PyInt_FromInt64(value).StealOrThrow()) { }

        /// <summary>
        /// Creates a new Python int from a <see cref="UInt64"/> value.
        /// </summary>
        public PyInt(ulong value) : base(PyLong_FromUnsignedLongLong(value).StealOrThrow()) { }
        ...
        /// </remarks>
        public PyInt(string value) : base(PyLong_FromString(value, 0).StealOrThrow()) { }

        public PyInt(BigInteger value) : this(value.ToString(CultureInfo.InvariantCulture)) { }

        protected PyInt(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        {
            if (value is null) { throw new ArgumentNullException(nameof(value)); }
            var op = PyNumber_Long(value.Reference);
        ...
        /// </remarks>
        //public short ToInt16() => Convert.ToInt16(ToInt32());
        ...
        public long ToInt64()
        {
            long? val = PyLong_AsLongLong(obj);
            if (val is null) { throw PythonException.ThrowLastAsClrException(); }
            return val.Value;
        }

        public BigInteger ToBigInteger()
        {
            using var pyHex = HexCallable.Invoke(this);
