...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public class PyDict : PyIterable
    {
        ...
        /// </summary>
        public PyDict() : base(PyDict_New().StealOrThrow()) { }
        ...
        {
            if (!IsDictType(o)) { throw new ArgumentException("object is not a dict"); }
        }

        protected PyDict(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        {
            using var items = PyDict_Keys(Reference);
            if (items.IsNull()) { throw PythonException.ThrowLastAsClrException(); }
        ...
        {
            using var items = PyDict_Values(obj);
        ...
        {
            using var items = PyDict_Items(this.Reference);
            if (items.IsNull()) { throw PythonException.ThrowLastAsClrException(); }
            return new PyIterable(items.Steal());
        }
        ...
        public void Update(PyObject other)
        {
            ...
            int result = PyDict_Update(Reference, other.Reference);
        ...
        /// </remarks>
        public void Clear() { PyDict_Clear(obj); }
