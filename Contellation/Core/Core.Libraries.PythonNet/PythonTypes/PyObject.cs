...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public partial class PyObject : DynamicObject, IDisposable, ISerializable
    {
        ...
        internal readonly int run = GetRun();
        ...
        internal PyObject(IntPtr ptr, bool skipCollect)
        {
            ...
            rawPtr = ptr;
            if (!skipCollect) { Finalizer.Instance.ThrottledCollect(); }
        }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (Py_IsInitialized() == 0 && _Py_IsFinalizing() != true)
            {
                throw new InvalidOperationException("Python runtime must be initialized");
            }

            nint refcount = Refcount(this.obj);
            ...
            if (refcount == 1)
            {
                ...
                try
                {
                    XDecref(StolenReference.Take(ref rawPtr));
        ...
        {
            if (run != GetRun()) { throw new RuntimeShutdownException(rawPtr); }
        }

        internal BorrowedReference GetPythonTypeReference() => PyObject_TYPE(obj);
        ...
        {
            var tp = PyObject_Type(Reference);
        ...
        public bool TypeCheck(PyType typeOrClass)
        {
            ...
            return PyObject_TypeCheck(obj, typeOrClass.obj);
        }
        ...
        public bool HasAttr(string name)
        {
            ...
            return PyObject_HasAttrString(Reference, name) != 0;
        }
        ...
        public bool HasAttr(PyObject name)
        {
            ...
            return PyObject_HasAttr(Reference, name.Reference) != 0;
        }
        ...
        public PyObject GetAttr(string name)
        {
            ...
            using var op = PyObject_GetAttrString(obj, name);
        ...
        public PyObject GetAttr(PyObject name)
        {
            ...
            using var op = PyObject_GetAttr(obj, name.obj);
            return new PyObject(op.StealOrThrow());
        }
        ...
        public void SetAttr(string name, PyObject value)
        {
            ...
            int r = PyObject_SetAttrString(obj, name, value.obj);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public void SetAttr(PyObject name, PyObject value)
        {
            ...
            int r = PyObject_SetAttr(obj, name.obj, value.obj);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public void DelAttr(string name)
        {
            ...
            int r = PyObject_DelAttrString(obj, name);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public void DelAttr(PyObject name)
        {
            ...
            int r = PyObject_DelAttr(obj, name.obj);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public virtual PyObject GetItem(PyObject key)
        {
            ...
            using var op = PyObject_GetItem(obj, key.obj);
            if (op.IsNull()) { throw PythonException.ThrowLastAsClrException(); }
            return new PyObject(op.Steal());
        }
        ...
        public virtual void SetItem(PyObject key, PyObject value)
        {
            ...
            int r = PyObject_SetItem(obj, key.obj, value.obj);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        public virtual void DelItem(PyObject key)
        {
            ...
            int r = PyObject_DelItem(obj, key.obj);
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
        }
        ...
        {
            var s = PyObject_Size(Reference);
            if (s < 0) { throw PythonException.ThrowLastAsClrException(); }
            return s;
        }
        ...
        public PyObject Invoke(params PyObject[] args)
        {
            ...
            using var r = PyObject_Call(obj, t.obj, null);
            t.Dispose();
        ...
        public PyObject Invoke(PyTuple args)
        {
            ...
            using var r = PyObject_Call(obj, args.obj, null);
            return new PyObject(r.StealOrThrow());
        }
        ...
        public PyObject Invoke(PyObject[] args, PyDict? kw)
        {
            ...
            using var r = PyObject_Call(obj, t.obj, kw is null ? null : kw.obj);
            return new PyObject(r.StealOrThrow());
        }
        ...
        public PyObject Invoke(PyTuple args, PyDict? kw)
        {
            ...
            using var r = PyObject_Call(obj, args.obj, kw is null ? null : kw.obj);
            return new PyObject(r.StealOrThrow());
        }
        ...
        public bool IsInstance(PyObject typeOrClass)
        {
            ...
            int r = PyObject_IsInstance(obj, typeOrClass.obj);
            if (r < 0)
            {
                PyErr_Clear();
                return false;
        ...
        internal bool IsSubclass(BorrowedReference typeOrClass)
        {
            ...
            int r = PyObject_IsSubclass(Reference, typeOrClass);
            if (r < 0)
            {
                PyErr_Clear();
                return false;
        ...
        public string? Repr()
        {
            using var strval = PyObject_Repr(obj);
            return GetManagedString(strval.BorrowOrThrow());
        }
        ...
        {
            using var _ = Py.GIL();
            using var strval = PyObject_Str(obj);
            return GetManagedString(strval.BorrowOrThrow());
        }
        ...
        string? DebuggerDisplay
        {
            get
            {
                if (DebugUtil.HaveInterpreterLock()) { return this.ToString(); }
                var obj = this.InternalManagedObject;
                return obj is { } ? obj.ToString() : $"pyobj at 0x{this.rawPtr:X} (get Py.GIL to see more info)";
            }
        }
        ...
        {
            get { return Refcount(obj); }
        }

        internal int CompareTo(BorrowedReference other)
        {
            int greater = PyObject_RichCompareBool(this.Reference, other, Py_GT);
        ...
        {
            int equal = PyObject_RichCompareBool(this.Reference, other, Py_EQ);
        ...
        public override bool TrySetMember(SetMemberBinder binder, object? value)
        {
            ...
            int r = PyObject_SetAttrString(obj, binder.Name, newVal.Borrow());
            if (r < 0) { throw PythonException.ThrowLastAsClrException(); }
            return true;
        }
        ...
        private void GetArgs(object?[] inargs, CallInfo callInfo, out PyTuple args, out PyDict? kwargs)
        {
            ...
            using var argTuple = PyTuple_New(regularArgumentCount);
        ...
        private static void AddArgument(BorrowedReference argtuple, nint i, object? target)
        {
            ...
            if (PyTuple_SetItem(argtuple, i, ptr.StealNullable()) < 0)
            {
                throw PythonException.ThrowLastAsClrException();
            }
        }
        ...
        public override bool TryConvert(ConvertBinder binder, out object? result)
        {
            ...
            if (Converter.ToManaged(this.obj, binder.Type, out result, false)) { return true; }

            if (binder.Explicit)
            {
                PyErr_Fetch(out var errType, out var errValue, out var tb);
                bool converted = Converter.ToManagedExplicit(Reference, binder.Type, out result);
                PyErr_Restore(errType.StealNullable(), errValue.StealNullable(), tb.StealNullable());
                return converted;
            }
        ...
        {
            int result = PyObject_RichCompareBool(this.obj, arg.obj, op);
            @out = result != 0;
            if (result < 0)
            {
                Exceptions.Clear();
        ...
        public override bool TryBinaryOperation(BinaryOperationBinder binder, object arg, out object? result)
        {
            ...
            switch (binder.Operation)
            {
                case ExpressionType.Add:
                    res = PyNumber_Add(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.AddAssign:
                    res = PyNumber_InPlaceAdd(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.Subtract:
                    res = PyNumber_Subtract(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.SubtractAssign:
                    res = PyNumber_InPlaceSubtract(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.Multiply:
                    res = PyNumber_Multiply(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.MultiplyAssign:
                    res = PyNumber_InPlaceMultiply(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.Divide:
                    res = PyNumber_TrueDivide(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.DivideAssign:
                    res = PyNumber_InPlaceTrueDivide(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.And:
                    res = PyNumber_And(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.AndAssign:
                    res = PyNumber_InPlaceAnd(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.ExclusiveOr:
                    res = PyNumber_Xor(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.ExclusiveOrAssign:
                    res = PyNumber_InPlaceXor(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.GreaterThan:
                    return this.TryCompare((PyObject)arg, Py_GT, out result);
                case ExpressionType.GreaterThanOrEqual:
                    return this.TryCompare((PyObject)arg, Py_GE, out result);
                case ExpressionType.LeftShift:
                    res = PyNumber_Lshift(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.LeftShiftAssign:
                    res = PyNumber_InPlaceLshift(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.LessThan:
                    return this.TryCompare((PyObject)arg, Py_LT, out result);
                case ExpressionType.LessThanOrEqual:
                    return this.TryCompare((PyObject)arg, Py_LE, out result);
                case ExpressionType.Modulo:
                    res = PyNumber_Remainder(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.ModuloAssign:
                    res = PyNumber_InPlaceRemainder(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.NotEqual:
                    return this.TryCompare((PyObject)arg, Py_NE, out result);
                case ExpressionType.Equal:
                    return this.TryCompare((PyObject)arg, Py_EQ, out result);
                case ExpressionType.Or:
                    res = PyNumber_Or(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.OrAssign:
                    res = PyNumber_InPlaceOr(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.Power:
                    res = PyNumber_Power(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.RightShift:
                    res = PyNumber_Rshift(this.obj, ((PyObject)arg).obj);
                    break;
                case ExpressionType.RightShiftAssign:
                    res = PyNumber_InPlaceRshift(this.obj, ((PyObject)arg).obj);
                    break;
                default:
                    result = null;
                    return false;
        ...
        public static bool operator ==(PyObject? a, PyObject? b)
        {
            ...
            using var _ = Py.GIL();
            int result = PyObject_RichCompareBool(a.obj, b.obj, Py_EQ);
        ...
        public static bool operator !=(PyObject? a, PyObject? b)
        {
            ...
            using var _ = Py.GIL();
            int result = PyObject_RichCompareBool(a.obj, b.obj, Py_NE);
        ...
        public override bool TryUnaryOperation(UnaryOperationBinder binder, out object? result)
        {
            ...
            switch (binder.Operation)
            {
                case ExpressionType.Negate:
                    res = PyNumber_Negative(this.obj);
                    break;
                case ExpressionType.UnaryPlus:
                    res = PyNumber_Positive(this.obj);
                    break;
                case ExpressionType.OnesComplement:
                    res = PyNumber_Invert(this.obj);
                    break;
                case ExpressionType.Not:
                    r = PyObject_Not(this.obj);
                    result = r == 1;
                    if (r == -1) Exceptions.Clear();
                    return r != -1;
                case ExpressionType.IsFalse:
                    r = PyObject_IsTrue(this.obj);
                    result = r == 0;
                    if (r == -1) Exceptions.Clear();
                    return r != -1;
