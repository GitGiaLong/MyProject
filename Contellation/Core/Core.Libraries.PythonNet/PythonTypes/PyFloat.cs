...
namespace Core.Libraries.PythonNet.PythonTypes
{
    ...
    public partial class PyFloat : PyNumber
    {
        ...
        /// </remarks>
        public PyFloat(double value) : base(PyFloat_FromDouble(value).StealOrThrow()) { }
        ...
        protected PyFloat(SerializationInfo info, StreamingContext context) : base(info, context) { }
        ...
        {
            if (value is null) { throw new ArgumentNullException(nameof(value)); }
            return PyFloat_Check(value.obj);
        }
        ...
        public double ToDouble() => PyFloat_AsDouble(obj);
