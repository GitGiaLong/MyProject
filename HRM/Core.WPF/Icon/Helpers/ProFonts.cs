...
namespace Core.WPF.Icon.Helpers
{
        ...
        internal static readonly Dictionary<int, string> FontTitles = new()
    {
        ...
        public static WpfFont WpfFontFor(this IconChar icon, IconFont iconFont = IconFont.Auto)
        {
        ...
        internal static WpfTypeface TypeFaceFor(this IconChar icon, IconFont iconFont)
        {
        ...
        public static WinFormsFont WinFormsFontFor(this IconChar icon)
        {
