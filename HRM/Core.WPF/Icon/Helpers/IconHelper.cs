...
namespace Core.WPF.Icon.Helpers
{
    public static class IconHelper
    {
        ...
        [SuppressMessage("ReSharper", "MemberCanBePrivate.Global")]
        public static IEnumerable<IconChar> Orphans { get; } = new[] { IconChar.None /* not contained in any of the ttf-fonts!*/ /*,IconChar.FontAwesomeLogoFull*/ };

        /// <summary>All valid icons.</summary>
        public static readonly IEnumerable<IconChar> Icons = Enum.GetValues(typeof(IconChar)).Cast<IconChar>().Except(Orphans).ToArray();
        ...
        /// Renders an image for the specified font and icon
        /// </summary>
        /// <param _Name="iconChar">The icon to render</param>
        /// <param _Name="brush">The icon brush / color</param>
        /// <param _Name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this IconChar iconChar, Brush brush = null, double size = DefaultSize)
        {
        ...
        /// <param _Name="size">The icon size in pixels</param>
        /// <returns>The rendered image</returns>
        public static ImageSource ToImageSource(this IconChar iconChar, IconFont iconFont, Brush brush = null, double size = DefaultSize)
        {
        ...
        #region Internal
        internal static FontFamily FontFor(IconChar iconChar) { return TypefaceFor(iconChar)?.FontFamily; }

        internal static FontFamily FontFor(IconChar iconChar, IconFont iconFont) { return TypefaceFor(iconChar, iconFont)?.FontFamily; }
