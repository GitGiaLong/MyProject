...
namespace Core.WPF.Appearance
{
    ...
    public static class ApplicationAccentColorManager
    {
        ...
        public static void Apply(Color systemAccent, ApplicationTheme applicationTheme = ApplicationTheme.Light, bool systemGlassColor = false)
        {
            ...
            if (systemGlassColor) { systemAccent = systemAccent.UpdateBrightness(6f); }
        ...
        {
            System.Diagnostics.Debug.WriteLine("INFO | SystemAccentColor: " + systemAccent, "CoreLibUI.Accent");
            System.Diagnostics.Debug.WriteLine("INFO | SystemAccentColorPrimary: " + primaryAccent, "CoreLibUI.Accent");
            System.Diagnostics.Debug.WriteLine("INFO | SystemAccentColorSecondary: " + secondaryAccent, "CoreLibUI.Accent");
            System.Diagnostics.Debug.WriteLine("INFO | SystemAccentColorTertiary: " + tertiaryAccent, "CoreLibUI.Accent");

            if (secondaryAccent.GetBrightness() > BackgroundBrightnessThresholdValue)
            {
                System.Diagnostics.Debug.WriteLine("INFO | Text on accent is DARK", "CoreLibUI.Accent");
                ...
                UiApplication.Current.Resources["TextOnAccentFillColorSelectedText"] = Color.FromArgb(0x00, 0x00, 0x00, 0x00);
                UiApplication.Current.Resources["AccentTextFillColorDisabled"] = Color.FromArgb(0x5D, 0x00, 0x00, 0x00);
            }
            else
            {
                System.Diagnostics.Debug.WriteLine("INFO | Text on accent is LIGHT", "CoreLibUI.Accent");
                ...
                UiApplication.Current.Resources["TextOnAccentFillColorSelectedText"] = Color.FromArgb(0xFF, 0xFF, 0xFF, 0xFF);
