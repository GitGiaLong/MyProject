...
namespace Core.WPF.Hardware
{
    ...
    internal static class DpiHelper
    {
        ...
        */
        ...
        {
            if (window is null) { return new Hardware.DisplayDpi(DefaultDpi, DefaultDpi); }
        ...
        {
            if (windowHandle == IntPtr.Zero || !UnsafeNativeMethods.IsValidWindow(windowHandle)) { return new Hardware.DisplayDpi(DefaultDpi, DefaultDpi); }
        ...
        public static Hardware.DisplayDpi GetSystemDpi()
        {
            ...
            if (dpiXProperty == null) { return new Hardware.DisplayDpi(DefaultDpi, DefaultDpi); }

            System.Reflection.PropertyInfo? dpiYProperty = typeof(SystemParameters).GetProperty("Dpi",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

            if (dpiYProperty == null) { return new Hardware.DisplayDpi(DefaultDpi, DefaultDpi); }
