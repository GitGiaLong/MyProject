...
namespace Core.WPF.Interop
{
    ...
    public static class UnsafeNativeMethods
    {
        ...
        public static bool ApplyWindowCornerPreference(Window window, WindowCornerPreference cornerPreference) => GetHandle(window, out IntPtr windowHandle)
        ...
        public static bool ApplyWindowCornerPreference(IntPtr handle, WindowCornerPreference cornerPreference)
        {
            ...
            if (!User32.IsWindow(handle)) { return false; }

            int pvAttribute = (int)UnsafeReflection.Cast(cornerPreference);

            // TODO: Validate HRESULT
            _ = Dwmapi.DwmSetWindowAttribute(handle, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_WINDOW_CORNER_PREFERENCE, ref pvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
        public static bool RemoveWindowDarkMode(Window? window) => GetHandle(window, out IntPtr windowHandle) && RemoveWindowDarkMode(windowHandle);
        ...
        public static bool RemoveWindowTitlebarContents(Window? window)
        {
            ...
            if (window.IsLoaded) { return GetHandle(window, out IntPtr windowHandle) && RemoveWindowTitlebarContents(windowHandle); }
        ...
        public static bool ApplyWindowBackdrop(IntPtr handle, WindowBackdropType backgroundType)
        {
            ...
            if (backdropPvAttribute == (int)Dwmapi.DWMSBT.DWMSBT_DISABLE) { return false; }

            /// TODO: Validate HRESULT
            _ = Dwmapi.DwmSetWindowAttribute(handle, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE, ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        public static bool IsWindowHasBackdrop(IntPtr handle, WindowBackdropType backdropType)
        {
            ...
            _ = Dwmapi.DwmGetWindowAttribute(handle, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE, ref pvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        public static bool IsWindowHasLegacyMica(Window? window) => GetHandle(window, out IntPtr windowHandle) && IsWindowHasLegacyMica(windowHandle);
        ...
        public static bool IsWindowHasLegacyMica(IntPtr handle)
        {
            ...
            _ = Dwmapi.DwmGetWindowAttribute(handle, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT, ref pvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        /// <param Name="window">The window to which the effect is to be applied.</param>
        /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
        public static bool ApplyWindowLegacyMicaEffect(Window? window) => GetHandle(window, out IntPtr windowHandle) && ApplyWindowLegacyMicaEffect(windowHandle);
        ...
        public static bool ApplyWindowLegacyMicaEffect(IntPtr handle)
        {
            ...
            // TODO: Validate HRESULT
            _ = Dwmapi.DwmSetWindowAttribute(handle, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT, ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        /// <param Name="window">The window to which the effect is to be applied.</param>
        /// <returns><see langword="true"/> if invocation of native Windows function succeeds.</returns>
        public static bool ApplyWindowLegacyAcrylicEffect(Window? window) => GetHandle(window, out IntPtr windowHandle) && ApplyWindowLegacyAcrylicEffect(windowHandle);
        ...
        internal static bool SetTaskbarState(IntPtr hWnd, ShObjIdl.TBPFLAG taskbarFlag)
        {
            ...
            if (new ShObjIdl.CTaskbarList() is not ShObjIdl.ITaskbarList4 taskbarList) { return false; }
        ...
        public static bool RemoveWindowCaption(IntPtr hWnd)
        {
            ...
            UxTheme.SetWindowThemeAttribute(hWnd, UxTheme.WINDOWTHEMEATTRIBUTETYPE.WTA_NONCLIENT, ref wtaOptions, (uint)Marshal.SizeOf(typeof(UxTheme.WTA_OPTIONS)));
        ...
        public static bool ExtendClientAreaIntoTitleBar(IntPtr hWnd)
        {
            ...
            Interop.UxTheme.SetWindowThemeAttribute(hWnd, UxTheme.WINDOWTHEMEATTRIBUTETYPE.WTA_NONCLIENT, ref wtaOptions, (uint)Marshal.SizeOf(typeof(UxTheme.WTA_OPTIONS)));

            DisplayDpi windowDpi = DpiHelper.GetWindowDpi(hWnd);

            /// #2 Extend glass frame
            Thickness deviceGlassThickness = DpiHelper.LogicalThicknessToDevice(new Thickness(-1, -1, -1, -1), windowDpi.DpiScaleX, windowDpi.DpiScaleY);
        ...
        /// <summary> Checks whether the DWM composition is enabled. </summary>
        ...
        /// <summary> Checks if provided pointer represents existing window. </summary>
        public static bool IsValidWindow(IntPtr hWnd) { return User32.IsWindow(hWnd); }
        ...
        {
            if (IntPtr.Size == 4) { return new IntPtr(User32.SetWindowLong(handle, (int)nIndex, (int)windowStyleLong)); }
