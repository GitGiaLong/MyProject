...
#pragma warning disable SA1307 // Accessible fields should begin with upper-case letter
    ...
    /// <summary> Desktop Window Manager (DWM). </summary>
    internal static class Dwmapi
    {
        ...
        [DllImport(Libraries.Dwmapi, PreserveSig = false)]
        public static extern int DwmSetIconicLivePreviewBitmap([In] IntPtr hWnd, [In] IntPtr hbmp, [In, Optional] WinDef.POINT pptClient, [In] DWM_SIT dwSITFlags);
