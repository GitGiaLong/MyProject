namespace Core.WPF.Interop.WinDef
{
    ...
    public struct RECTL
    {
        ...
        /// <summary> Combines two RECTLs </summary>
        ...
        {
            if (obj is not RECTL) { return false; }
        ...
        public static bool operator == (RECTL left, RECTL right) { return left.Equals(right); }

        public static bool operator != (RECTL left, RECTL right) { return !(left == right); }
    }
}
