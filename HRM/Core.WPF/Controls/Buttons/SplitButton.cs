...
namespace Core.WPF.Controls
{
    ...
    /// One part behaves like a standard button and the other part invokes a flyout.
    /// </summary>
    ...
    public class SplitButton : Button
    {
        ...
        /// <summary> Gets or sets control responsible for toggling the drop-down button. </summary>
        ...
        {
            if (d is SplitButton dropDownButton) { dropDownButton.OnIsDropDownOpenChanged(e.NewValue is bool boolVal && boolVal); }
        }

        protected virtual void OnContextMenuClosed(object sender, RoutedEventArgs e) { SetCurrentValue(IsDropDownOpenProperty, false); }

        protected virtual void OnContextMenuOpened(object sender, RoutedEventArgs e) { SetCurrentValue(IsDropDownOpenProperty, true); }
