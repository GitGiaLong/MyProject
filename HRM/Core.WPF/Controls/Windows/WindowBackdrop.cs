...
namespace Core.WPF.Controls.Windows
{
    ...
    public static class WindowBackdrop
    {
        ...
        public static bool ApplyBackdrop(IntPtr hWnd, WindowBackdropType backdropType)
        {
            ...
            if (ApplicationThemeManager.GetAppTheme() == ApplicationTheme.Dark) { _ = UnsafeNativeMethods.ApplyWindowDarkMode(hWnd); }
            else { _ = UnsafeNativeMethods.RemoveWindowDarkMode(hWnd); }
        ...
        public static bool RemoveBackdrop(IntPtr hWnd)
        {
            ...
            _ = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT, ref pvAttribute, Marshal.SizeOf(typeof(int)));

            _ = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE, ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        public static bool RemoveBackground(System.Windows.Window? window)
        {
            ...
            if (windowSource?.Handle != IntPtr.Zero && windowSource?.CompositionTarget != null) { windowSource.CompositionTarget.BackgroundColor = Colors.Transparent; }
        ...
        private static bool ApplyDwmwWindowAttrubute(IntPtr hWnd, Dwmapi.DWMSBT dwmSbt)
        {
            ...
            var dwmApiResult = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_SYSTEMBACKDROP_TYPE, ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        private static bool ApplyLegacyMicaBackdrop(IntPtr hWnd)
        {
            ...
            var dwmApiResult = Dwmapi.DwmSetWindowAttribute(hWnd, Dwmapi.DWMWINDOWATTRIBUTE.DWMWA_MICA_EFFECT, ref backdropPvAttribute, Marshal.SizeOf(typeof(int)));
        ...
        private static bool RestoreContentBackground(IntPtr hWnd)
        {
            ...
            if (windowSource?.Handle != IntPtr.Zero && windowSource?.CompositionTarget != null) { windowSource.CompositionTarget.BackgroundColor = SystemColors.WindowColor; }
            ...
            if (windowSource?.RootVisual is System.Windows.Window window)
            {
                ...
                /// Manual fallback
                if (backgroundBrush is not SolidColorBrush) { backgroundBrush = GetFallbackBackgroundBrush(); }
