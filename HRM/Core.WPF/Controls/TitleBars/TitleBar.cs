...
namespace Core.WPF.Controls
{
    ...
    public class TitleBar : System.Windows.Controls.Control
    {
        ...
        {
            get { return (ApplicationTheme)GetValue(ApplicationThemeProperty); }
        ...
        /// <summary> Gets or sets the background of the navigation buttons when hovered. </summary>
        ...
        /// <summary> Gets a value indicating whether the current window is maximized. </summary>
        ...
        /// <summary> Gets or sets a value indicating whether the controls affect main application window. </summary>
        ...
        /// <summary> Gets or sets a value indicating whether to show the maximize button. </summary>
        ...
        /// <summary> Gets or sets a value indicating whether to show the minimize button. </summary>
        ...
        /// <summary> Gets or sets a value indicating whether to show the help button </summary>
        ...
        /// <summary> Gets or sets a value indicating whether to show the close button. </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the maximize functionality is enabled. 
        /// If disabled the MaximizeActionOverride action won't be called
        /// </summary>
        ...
        /// <summary> Gets or sets the titlebar icon. </summary>
        //public Image? Icon
        ...
        /// <summary> Gets or sets a value indicating whether the window can be closed by double clicking on the icon </summary>
        ...
        /// <summary> Gets the command triggered when clicking the titlebar button. </summary>
        ...
        /// <summary> Gets or sets the <see cref="Action"/> that should be executed when the Maximize button is clicked."/> </summary>
        public Action<TitleBar, System.Windows.Window>? MaximizeActionOverride { get; set; }

        /// <summary> Gets or sets what <see cref="Action"/> should be executed when the Minimize button is clicked. </summary>
